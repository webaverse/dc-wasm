...
emcc -sNO_EXIT_RUNTIME=1 -s TOTAL_MEMORY=1999896576 -s ALLOW_MEMORY_GROWTH=0 -sWASM_WORKERS -O3 -g -s ASSERTIONS=1 -fexceptions \
  objectize.cc \
  ...
  sed -Ei 's/importScripts\(d.js\);/d.js="\/dc.js";importScripts(d.js);/g' bin/dc.ww.js

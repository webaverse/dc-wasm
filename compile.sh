...
emcc -D NUM_THREADS=10 -sNO_EXIT_RUNTIME=1 -s TOTAL_MEMORY=1999896576 -pthread -sPTHREAD_POOL_SIZE=10 -sPTHREAD_POOL_SIZE_STRICT=10 -s ALLOW_MEMORY_GROWTH=0 -O3 \
  objectize.cc \

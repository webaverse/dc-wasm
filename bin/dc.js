...
var ASM_CONSTS = {
  35196: () => { console.log('task queue destructor'); },  
 35238: ($0, $1) => { handleResult($0, $1); },  
 35264: ($0) => { console.log('Node already exists:', $0); },  
 35309: ($0) => { console.log('Duplicate lod1 node:', $0); },  
 35354: ($0, $1, $2) => { console.log('Leaf node contains another leaf node 2:', $0, $1, $2); }
};

...
var ASM_CONSTS = {
  33268: ($0, $1) => { const id = $0; const result = $1; if (!globalThis.resultEvent) { globalThis.resultEvent = new MessageEvent('result', { data: { id: 0, result: 0, }, }); } globalThis.resultEvent.data.id = id;; globalThis.resultEvent.data.result = result; globalThis.dispatchEvent(globalThis.resultEvent); }
};
  ...
  function _emscripten_wasm_worker_post_function_2(id, funcPtr, arg0, arg1) {
      _wasm_workers[id].postMessage({'_wsc': funcPtr, 'x': [arg0, arg1] }); // "WaSm Call"
    }
  function _emscripten_wasm_worker_post_function_vii(a0,a1,a2,a3
  ) {
  return _emscripten_wasm_worker_post_function_2(a0,a1,a2,a3);
  }

  function _emscripten_wasm_worker_self_id() {
      return Module['$ww'];
    }
...
var asmLibraryArg = {
  ...
  "emscripten_wasm_worker_self_id": _emscripten_wasm_worker_self_id,
